...
// 检查依赖项
#[tauri::command]
pub async fn check_dependencies() -> Result<(bool, bool), String> {
...
// 检查文件是否已处理
#[tauri::command]
pub async fn check_file_processed(video_path: String) -> Result<bool, String> {
    // 获取视频文件的目录和文件名
...
// 处理视频生成GIF动画
#[tauri::command]
pub async fn process_video_gif(
    app: AppHandle,
    path: String,
    thumbnails: u32,
    width: u32,
